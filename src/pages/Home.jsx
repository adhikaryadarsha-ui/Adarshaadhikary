      ...
      <section className="py-2">
        <div className="max-w-7xl mx-auto px-6">
          <h1 className="text-5xl text-center font-black">
            ABOUT <span className="font-bold text-orange-600">ME</span>
          </h1>
          <div className="grid md:grid-cols-2 mt-20 gap-16">
            <div className="text-lg max-w-xl">
              ...
              <p className='mt-2'>
                ...
                ideas into functional and user-friendly websites.</p><p className='mt-2'> I also have
                experience working with design tools like Adobe Photoshop and
                Adobe Illustrator, which helps me create better UI designs and
                graphics.
              </p>
            </div>
